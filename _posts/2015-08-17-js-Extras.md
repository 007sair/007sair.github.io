...
在ie8以上的浏览器中，`indexOf`会被认为是预定义属性，使用`for in`时自然不会被枚举到。而ie8以下的js版本中并没有预定义`indexOf`，是我们自定义的方法，所以自然就被枚举到了。

而`for in`语句可用来遍历一个对象中的所有属性名，该枚举过程将会列出所有的属性，包括函数和你可能不关心的原型中的属性。
...
- <a rel="nofollow" href="" target="_blank" title="">js对象中什么是可枚举性(enumerable)？</a>
...
- <a href="http://www.cnblogs.com/dolphinX/p/3348467.html" target="_blank" title="">ECMAScript5 Object的新属性方法 </a>
- <a href="http://blog.csdn.net/haojianfeng11/article/details/16331963" target="_blank" title="">JS 对象属性"可枚举"</a>
